...
const ReviewProducts :NextPage = () => {
    return (
        <div>
        <p className="text-center text-2xl my-5 font-semibold">Our Products Review</p>
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="timeline-start md:text-end mb-10">
              <time className="font-mono italic">Tanim Shikder</time>
          ...
          <li>
            ...
            <div className="timeline-end mb-10">
              <time className="font-mono italic">Habib Ullah</time>
          ...
          <li>
            ...
            <div className="timeline-start md:text-end mb-10">
              <time className="font-mono italic">Nor Rashid Khan</time>
          ...
          <li>
            ...
            <div className="timeline-end mb-10">
              <time className="font-mono italic">Kamrul Hasan</time>
