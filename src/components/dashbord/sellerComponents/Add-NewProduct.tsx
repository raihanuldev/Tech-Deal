    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    <label htmlFor="model" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Model</label>
                    <input 
                        type="text" 
                        id="model" 
                    ...
                    />
                    {errors.model && <span className="text-red-500 text-sm">Product model is required</span>}
                </div>
                <div>
                ...
                <div>
                    <label htmlFor="img" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Image URL</label>
                    <input 
                        type="text" 
                        id="img" 
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    />
                    {errors.img && <span className="text-red-500 text-sm">Image URL is required</span>}
                </div>  
                <div>
                ...
                <div>
                    <label htmlFor="resalePrice" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Resale Price</label>
                    <input 
                        type="number" 
                        id="resalePrice" 
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    />
                    {errors.resalePrice && <span className="text-red-500 text-sm">Resale price is required</span>}
                </div>
                <div>
                    <label htmlFor="originalPrice" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Original Price</label>
                    <input 
                        type="number" 
                        id="originalPrice" 
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    />
                    {errors.originalPrice && <span className="text-red-500 text-sm">Original price is required</span>}
                </div>
                <div>
                    <label htmlFor="used" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Used (in months)</label>
                    <input 
                        type="number" 
                        id="used" 
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    />
                    {errors.used && <span className="text-red-500 text-sm">Used duration is required</span>}
                </div>
                <div>
