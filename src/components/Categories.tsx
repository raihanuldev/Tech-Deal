...
const CategoriesProducts: NextPage = () => {
  ...
  const categories = [
    ...
    { name: "cameras", imageUrl: "https://media.istockphoto.com/id/185278433/photo/black-digital-slr-camera-in-a-white-background.jpg?s=1024x1024&w=is&k=20&c=UjIzN8-KrVm1urSdQdwmfsy2Iiln2Si6AZozCx5F6dM=" },
